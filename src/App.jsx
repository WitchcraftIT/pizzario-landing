...
export default function App() {
  ...
  return <main><Header count={count} onCart={() => setCartOpen(true)}/><Hero pizza={featured} pizzas={pizzas} onSelect={setFeatured} onAdd={addToCart}/><PopularMenu pizzas={pizzas} onAdd={addToCart}/><Benefits/><DeliveryForm/><Reviews/><Footer/><CartDrawer open={cartOpen} onClose={() => setCartOpen(false)} items={cart} onChange={changeQty} onRemove={remove} total={total}/></main>
}
