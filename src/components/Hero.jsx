...
export default function Hero({ pizza, pizzas, onSelect, onAdd }) {
  return <section id="top" className="px-3 pb-12 pt-5 sm:px-6 sm:pb-20">
    <div className="hero-stage relative mx-auto min-h-[660px] max-w-[1360px] overflow-hidden rounded-[32px] bg-[#fffdfa] shadow-soft lg:min-h-[730px]">
      ...
      <h1 className="hero-title absolute left-1/2 top-[104px] z-[1] w-[92%] -translate-x-1/2 whitespace-nowrap text-center font-display text-[clamp(3rem,7.25vw,8.65rem)] leading-[.85] tracking-[-.055em] text-ink"><span className="text-tomato">NEW</span> PIZZA COLLECTION</h1>
      <motion.div key={pizza.id} initial={{ opacity: 0, scale: 0.95, y: 14 }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ duration: 0.45 }} className="hero-pizza absolute left-1/2 top-[55%] z-[3] w-[min(91vw,680px)] -translate-x-1/2 -translate-y-[35%] lg:w-[680px]">
